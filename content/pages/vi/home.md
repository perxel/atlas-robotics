...
modifiedDate: 2026-08-09T08:52:57.636Z
seo:
  metaTitle: 'Atlas Robotics — Robot, Vệ Tinh, Và Phần Mềm Kết Nối Chúng'
  metaDescription: 'Atlas Robotics chế tạo cánh tay robot, robot bốn chân, nền tảng robot hình người, và mạng lưới vệ tinh trung chuyển giữ chúng luôn kết nối — thiết kế cho sàn nhà máy thực tế, không chỉ video demo.'
  ogImage: /uploads/boston-dynamics-robot-in-a-car-factory.jpg
hideTitle: true
blocks:
  - slides:
      - heading: Robot Được Chế Tạo Cho Công Việc Thực Sự
        subheading: 'Từ sàn nhà máy đến hành lang bệnh viện, Atlas Robotics chế tạo những cỗ máy trụ vững suốt cả ca làm việc — không chỉ đẹp trong video demo.'
      ...
      - heading: Vượt Ra Ngoài Mặt Đất
        subheading: 'Orbit Relay giữ mọi robot chúng tôi chế tạo luôn kết nối, kể cả qua địa hình vốn sẽ làm mất tín hiệu.'
      ...
      - heading: Bất Kể Địa Hình Nào
        subheading: 'Cầu thang, tuyết, bến bốc dỡ — những nơi robot bánh xe phải bỏ cuộc chính là nơi robot của chúng tôi bắt đầu làm việc.'
      ...
      - heading: Chính Xác Đến Từng Khớp Nối
        subheading: 'Mọi linh kiện chúng tôi không thể mua đúng chuẩn, chúng tôi tự in hoặc tự gia công — đạt chuẩn kỹ thuật, ngay trên sàn của mình.'
      ...
      - heading: Đội Ngũ Đứng Sau Những Cỗ Máy
        subheading: Robot là sản phẩm. Nhưng những người chế tạo ra chúng vẫn có ngày nghỉ lễ — đọc xem chúng tôi đã làm gì.
