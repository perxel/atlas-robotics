...
highlights:
  ...
  - 'Đồng bộ hai chiều với lịch và tài liệu hiện có'
  - 'Cho phép khách/đối tác truy cập mà không cần mua thêm chỗ ngồi'
productCategories:
...
## Những gì nó thay thế

- Luồng tin nhắn Slack không ai tìm lại được
- Tài liệu chỉ một người biết đường link
- Cuộc họp cập nhật tình trạng tồn tại vì không ai tin vào công cụ theo dõi

## Cách các nhóm sử dụng

Dự án, tài liệu và hội thoại đều nằm ở một nơi, đồng bộ hai chiều với lịch và công cụ tệp bạn đang dùng. Mời khách hàng hoặc đối tác dưới dạng khách mà không cần mua thêm chỗ ngồi đầy đủ.
